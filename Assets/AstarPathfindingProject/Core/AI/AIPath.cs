...
public class AIPath : MonoBehaviour {
	...
	public virtual void Update () {
		...
		DesiredVelocity = CalculateVelocity(GetFeetPosition());

		//Rotate towards targetDirection (filled in by CalculateVelocity)
		RotateTowards(targetDirection);

		//commented out, rvomanager will simulate avoidance velocities, and call move on objects instead
//		if (controller != null) {
...
//		}
	...
	public void Move(Vector3 v)
	{
		...
		if (controller != null) {
			...
			tr.Translate (v*Time.deltaTime, Space.World);
		}
	}
